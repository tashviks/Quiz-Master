/**
 * This class contains constant values that are used throughout the app
 * @property USER_NAME is the key used to store the user name in shared preference
 * @property TOTAL_QUESTIONS is the key used to store the total number of questions in shared preference
 * @property CORRECT_ANSWERS is the key used to store the number of correct answers in shared preference
 * @property getQuestions is a function that returns a list of questions and used in MainActivity
 */
